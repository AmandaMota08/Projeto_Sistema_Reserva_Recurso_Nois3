...
<<<<<<< HEAD
//Aplica RN simulada e resgistra no histórico
...
>>>>>>> 3d02e32101d8711d81317760e9763e0aca8ee14f
...
function renderItemReserva({recurso,data,hora,justificativa,status}){
    ...
    const li = document.createElement('li');
    const quando = new Date(`${data}TS{hora}`).toLocaleString('pt-br');
